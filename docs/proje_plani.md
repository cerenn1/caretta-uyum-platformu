...
- **Puan/rozet sistemi ödül türü henüz karara bağlanmadı:** Uygulamadaki rozet seviyeleri (Bronz/Gümüş/Altın) bir ödül hak edildiğini bildiriyor, ama ödülün TÜRÜ — partner otelde indirim kodu mu, doğrudan küçük bir maddi ödül mü, yoksa başka bir teşvik mi — henüz bir iş kararı olarak netleşmedi. Bunun nedeni: platformun şu an gerçek bir partner otel anlaşması yok, dolayısıyla "otel indirimi" vaadi bugün için karşılığı olmayan bir söz olurdu. Uygulama bu yüzden kullanıcıya sadece genel/net-ama-belirsiz bir mesaj gösteriyor ("bir ödül hak ettin, detaylar için proje yöneticinle iletişime geç"); ödül türü, bütçe ve/veya gerçek bir otel/STK ortaklığı netleştiğinde aktif hale getirilmeli. Bu netleşene kadar, rol fark etmeksizin (hem otel çalışanı hem normal kullanıcı) herkesin hemen indirebileceği bir "Katkı Sertifikası" (PDF) somut ve gerçekten üretilebilir bir ara teşvik olarak sunuluyor.